...
//import 'package:noobmusic/CustomWidgets/copy_clipboard.dart';
...
import 'package:noobmusic/CustomWidgets/popup.dart';
import 'package:noobmusic/CustomWidgets/snackbar.dart';
import 'package:noobmusic/CustomWidgets/textinput_dialog.dart';
import 'package:noobmusic/Helpers/backup_restore.dart';
import 'package:noobmusic/Helpers/config.dart';
import 'package:noobmusic/Helpers/countrycodes.dart';
import 'package:noobmusic/Helpers/picker.dart';
import 'package:noobmusic/Helpers/supabase.dart';
import 'package:noobmusic/Screens/Home/saavn.dart' as home_screen;
import 'package:noobmusic/Screens/Settings/player_gradient.dart';
//import 'package:noobmusic/Screens/Top Charts/top.dart';
import 'package:noobmusic/Services/ext_storage_provider.dart';
import 'package:noobmusic/main.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String downloadPath = Hive.box('settings')
      .get('downloadPath', defaultValue: '/storage/emulated/0/NoobMusic') as String;
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/noobmusic/Backups',
  ) as String;
                        ...
                        ListTile(
                          ...
                          trailing: TextButton(
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                        dirName: 'noobmusic/Backups',
                                      ) ??
                                      '/storage/emulated/0/noobmusic/Backups';
                              Hive.box('settings')
                       ...
                       /* ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '${AppLocalizations.of(
                                context,
                              )!.shareAppText}: https://github.com/Sangwan5688/noobmusic',
                            );
                          },
                          dense: true,
                        ),
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'upi://pay?pa=ankit.sangwan.5688@oksbi&pn=noobmusic';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dnoobmusicyoucantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
                        ...
                        ListTile(
                          ...
                          dense: true,
                          onTap: () {
                            auth.signOut().then((value) => Navigator.pushNamedAndRemoveUntil(context, '/aut', (route) => false));
                          },
